...
#define HAL_SYSTEM_WD_MODE_DISABLE            0x00
#define HAL_SYSTEM_WD_MODE_1S                 0x01
#define HAL_SYSTEM_WD_MODE_250MS              0x02
#define HAL_SYSTEM_WD_MODE_15MS_250US         0x03
   
#define HAL_SYSTEM_WD_MODE_NUM                0x04

#define HAL_SYSTEM_SET_WATCHDOG(__TYPE__)    \
   switch(__TYPE__) {                           \
     case HAL_SYSTEM_WD_MODE_DISABLE:      \
       break;                                   \
     case HAL_SYSTEM_WD_MODE_1S:           \
       WDCTL = 0x01; WDCTL |= 0x08;             \
       break;                                   \
     case HAL_SYSTEM_WD_MODE_250MS:        \
       WDCTL = 0x02; WDCTL |= 0x08;             \
       break;                                   \
     case HAL_SYSTEM_WD_MODE_15MS_250US:   \
       WDCTL = 0x03; WDCTL |= 0x08;             \
       break;                                   \
   }
