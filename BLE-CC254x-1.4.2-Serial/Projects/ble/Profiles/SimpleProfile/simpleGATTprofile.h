...
// Profile Parameters
#define SIMPLEPROFILE_CHAR_SC                           0  // RW uint8 - Profile Characteristic 5 value
#define SIMPLEPROFILE_CHAR_CS                           1  // RW uint8 - Profile Characteristic 5 value
 ...
 *          uint16 pointer).
 */
extern bStatus_t SimpleProfile_SetParameter( uint8 param, void *value, uint8 len );
 ...
 *          uint16 pointer).
 */
extern bStatus_t SimpleProfile_GetParameter( uint8 param, uint8 **value, uint8** len );
